...
from propvg.apis import inference_model
...
def parse_args():
    ...
    parser.add_argument(
        "--config",
        default="work_dir/gres/compare/only_refer/20250123_174534/20250123_174534_only_refer.py",
        help="inference config file path.",
    )

    parser.add_argument(
        "--checkpoint",
        default="work_dir/gres/compare/only_refer/20250123_174534/latest.pth",
        help="the checkpoint file to load from.",
    )
    parser.add_argument(
        "--output-dir",
        default="visualization/grefcoco/onlyrefer",
    ...
    parser.add_argument("--nms", default=True, type=bool, help="nms")
    parser.add_argument(
        "--score-weighted",
        default=True,
        type=bool,
