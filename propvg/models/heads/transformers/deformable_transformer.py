...
class DeformableDetrTransformerDecoder(TransformerLayerSequence):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.return_intermediate:
            return torch.stack(intermediate), torch.stack(intermediate_reference_points), torch.stack(att_maps)

        return output, reference_points, att_map
...
class DeformableDetrTransformer(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # decoder
        inter_states, inter_references, att_map = self.decoder(
        ...
        return inter_states, init_reference_out, inter_references_out, None, None, att_map
