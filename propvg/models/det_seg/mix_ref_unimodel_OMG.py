...
from propvg.models.postprocess.nms_reverse import nms_reve
...
class MIXRefUniModel_OMG(OneStageModel):
    def __init__(
        self,
        word_emb,
        num_token,
        ...
        super(MIXRefUniModel_OMG, self).__init__(word_emb, num_token, vis_enc, lan_enc, head, fusion)
    ...
    def get_predictions_parts(self, pred, img_metas, rescale=False, with_bbox=False, with_mask=False):
        ...
        all_bbox_cls, all_bboxes, global_seg_mask, refer_pred = (
        ...
        if with_mask:
            ...
            for ind, (img_meta, global_mask) in enumerate(zip(img_metas, global_mask_binary)):
                ...
                pred_masks.append({"pred_masks": pred_rle, "gt_nt": gt_nt})
