...
train_pipeline = [
    ...
    dict(
        type="CollectData", keys=["img", "ref_expr_inds", "gt_mask_rle", "is_crowd", "gt_mask_vertices", "mass_center"]
    ),
]
val_pipeline = [
    dict(type="LoadImageAnnotationsFromFile", max_token=15, with_mask=True, dataset="RefCOCOPlusUNC"),
...
data = dict(
    ...
    train=dict(
        ...
        which_set="train",
        img_source=["coco"],
        annsfile=data_root + "annotations/refcocoplus-unc/instances_withid.json",
